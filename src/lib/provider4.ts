...
/**
 * Neptune tidak memakai pemilihan operator: selalu "any".
 * Stok berbasis /offers agregat semua operator, jadi filter operator spesifik
 * menyesatkan (stok tampil tidak sesuai operator).
 */
