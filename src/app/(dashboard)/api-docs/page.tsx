...
curl -X POST \\
  ...
  const apiEndpoints = [
    ...
    { method: "GET", path: "/countries", description: "Daftar negara yang tersedia per server. Gunakan field `id` untuk parameter `country` saat order.", example: `// Query: ?server=api1\n// Server pilihan: api1, api2, api3, api4\n\n{\n  "success": true,\n  "data": [\n    { "id": 0,  "name": "Russia" },\n    { "id": 6,  "name": "Indonesia" },\n    { "id": 22, "name": "India" }\n  ],\n  "timestamp": "2026-03-11T16:31:48.817Z"\n}` },
