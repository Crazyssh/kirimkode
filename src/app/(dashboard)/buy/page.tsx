    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-96 shrink-0 space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`w-2 h-2 rounded-full ${
                            (server.id === "api3" || server.id === "api4" || server.id === "unified" ? server.status : (serverHealth[server.id] || server.status)) === "online"
                              ? "bg-success"
                              : "bg-red-500"
                          }`}
                        />
                  ...
                  <div className="relative mb-3" ref={countryDropdownRef}>
                    ...
                    >
                      <span className="flex items-center gap-2">
                        {selectedNegara
                          ? <>{getCountryFlagUrl(selectedNegara.nama_negara) && <img src={getCountryFlagUrl(selectedNegara.nama_negara)!} alt="" className="w-5 h-4 object-cover rounded-sm" />}{capitalizeFirst(selectedNegara.nama_negara)}</>
                          : t("buy.selectCountry")}
                      </span>
          ...
          {/* Provider Dropdown - shown for api1/Mars, api7/Mars V2, api5/Earth, api4/Neptune (not unified mode) */}
          {(selectedServer.id === "api1" || selectedServer.id === "api7" || selectedServer.id === "api5" || selectedServer.id === "api4") && (
