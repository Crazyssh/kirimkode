  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        if (server && ["api1", "api2", "api3", "api5", "api6", "api7", "api8", "api9", "api10"].includes(server)) {
          send(`[Sync] Starting ${server}...`);
          const result = await syncProvider(server as "api1" | "api2" | "api3" | "api5" | "api6" | "api7" | "api8" | "api9" | "api10");
          ...
          const results = [];
          for (const srv of ["api1", "api2", "api3", "api5", "api6", "api7", "api8", "api9", "api10"] as const) {
