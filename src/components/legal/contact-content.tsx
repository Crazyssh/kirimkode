    ...
    return (
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card>
            <CardContent>
              ...
              <p className="text-sm text-muted mb-2">For technical support and general inquiries</p>
          ...
          <Card>
            <CardContent>
              ...
              <p className="text-sm text-muted mb-1">Monday - Friday: 09:00 - 21:00 WIB</p>
              <p className="text-sm text-muted">Saturday - Sunday: 10:00 - 18:00 WIB</p>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold font-[family-name:var(--font-space-grotesk)]">Quick FAQ</h2>
          <div className="space-y-3">
            {[
              { q: "My balance hasn't arrived after deposit", a: "Wait 1-5 minutes. If it still hasn't arrived, contact support with proof of payment." },
              { q: "OTP not received even though the number is active", a: "Try cancelling and buying a new number. Balance is automatically refunded if OTP doesn't arrive within 20 minutes." },
              { q: "My account is blocked", a: "Contact support via email explaining your situation. Our team will review your case." },
            ].map((faq) => (
        ...
        <div className="p-6 rounded-xl bg-primary/5 border border-primary/20 text-center">
          <h3 className="font-bold mb-2">Business Partnership?</h3>
          <p className="text-sm text-muted mb-3">
            For business partnerships, resellers, or enterprise needs, contact us at:
          </p>
